-- "Other ambassadors" badge analytics. Extend the event_type CHECK enum
-- with listing_ambassadors_badge_click so the public-page badge tap can
-- record into model_analytics_events (lockstepped with ALLOWED_EVENT_TYPES
