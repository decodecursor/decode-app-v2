...
- [ ] Instagram link fires analytics event (check DB) — **4D scope (deferred to analytics track endpoints)**
...
- [ ] Turnstile verifies silently (no visible CAPTCHA) — **4D scope**
