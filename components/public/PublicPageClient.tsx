...
export default function PublicPageClient({
  ...
  return (
    ...
    >
      ...
      {/* Trust Stack Pro Info modal — vaul-backed drawer. ALWAYS mounted
          (conditional mount would clip vaul's exit animation when the
          listing flips to null on close); visibility is the `open` prop.
          Listing is found-or-null; ProInfoModal also guards on it. */}
      <ProInfoModal
