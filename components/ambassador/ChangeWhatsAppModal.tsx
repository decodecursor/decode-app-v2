...
export function ChangeWhatsAppModal({
  ...
  onClose: () => void
  currentPhone: string
  onChanged: (phoneE164: string) => void
}) {
  ...
  const verifyCode = useCallback(
    async (fullCode: string) => {
      ...
      try {
        ...
        setChangedPhone(data.phone || e164)
        setStep(3)
      } catch {
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 32 }}>
              ...
              >
                ...
                <div style={{
                  ...
                  {formatDisplayPhone(currentPhone, selectedCountry.code)}
                </div>
              </div>
              <div style={{ flexShrink: 0 }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#e91e8c" strokeWidth="2.5" strokeLinecap="round">
              ...
              >
                ...
                <div style={{
                  ...
                  {formatDisplayPhone(changedPhone, selectedCountry.code)}
                </div>
              </div>
            </div>
...
// Duplicated from AddWhatsAppModal.tsx per "rule of three" — extract to lib/ambassador/phone-format.ts if a third caller emerges.
