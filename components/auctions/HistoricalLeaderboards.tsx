    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-500">No completed auctions yet</p>
        </div>
      </div>
    );
  }
          ...
          <div key={auction.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4 hover:shadow-md hover:border-gray-400 transition-all duration-200">
            ...
            <div className="mb-3">
              <a
                ...
                className="font-medium text-lg text-gray-900 hover:text-pink-600 hover:underline transition-colors block truncate"
              >
                {auction.title}
              </a>
