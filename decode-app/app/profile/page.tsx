...
export default function ProfilePage() {
  ...
  const { user, profile: contextProfile, loading: contextLoading, isAuthenticating, authCompleted, refreshProfile } = useUser()
  ...
  if (contextLoading || isAuthenticating || loading || (!user && !authCompleted)) {
    return (
      <div className={contextProfile?.role === USER_ROLES.MODEL ? 'cosmic-bg-model' : 'cosmic-bg'}>
