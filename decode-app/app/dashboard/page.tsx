...
export default function Dashboard() {
  ...
  return (
    ...
    >
      <div className={`${profile?.role === USER_ROLES.MODEL ? 'cosmic-bg-model' : 'cosmic-bg'} dashboard-page`}>
        <div className="min-h-screen px-4 py-1.5 md:py-8">

        {/* Navigation Menu */}
        <div className="mx-auto dashboard-header-card-spacing" style={{maxWidth: '3000px'}}>
          <div className="cosmic-card-dashboard" style={{padding: '12px 17px'}}>
            {/* Desktop Navigation */}
            ...
            <div className="md:hidden">
              ...
              {mobileMenuOpen && (
                <div className="border-t mt-3 pt-4" style={{
