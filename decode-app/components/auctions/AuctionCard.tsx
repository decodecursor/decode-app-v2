...
export function AuctionCard({ auction, showCreator = false }: AuctionCardProps) {
  ...
  const getStatusBadge = () => {
    ...
    if (auction.status === 'cancelled') {
      return (
        <span className="px-1.5 md:px-3 py-0.5 md:py-1.5 text-[8px] md:text-sm font-medium text-red-500 bg-red-900/30 backdrop-blur-md rounded-full border border-red-500 flex items-center gap-0.5 md:gap-1.5">
          <svg className="w-2 h-2 md:w-3.5 md:h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    if (hasEnded) {
      ...
      if (auction.total_bids > 0) {
        return (
          <span className="px-1.5 md:px-3 py-0.5 md:py-1.5 text-[8px] md:text-sm font-medium text-green-500 bg-green-900/30 backdrop-blur-md rounded-full border border-green-500 flex items-center gap-0.5 md:gap-1.5">
            <svg className="w-2 h-2 md:w-3.5 md:h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      return (
        <span className="px-1.5 md:px-3 py-0.5 md:py-1.5 text-[8px] md:text-sm font-medium text-gray-500 bg-gray-900/30 backdrop-blur-md rounded-full border border-gray-500 flex items-center gap-0.5 md:gap-1.5">
          <svg className="w-2 h-2 md:w-3.5 md:h-3.5" fill="currentColor" viewBox="0 0 24 24">
    ...
    switch (auction.status) {
      case 'active':
        return (
          <span className="px-1.5 md:px-3 py-0.5 md:py-1 text-[8px] md:text-xs font-medium text-purple-500 bg-purple-900/30 backdrop-blur-md rounded-full border border-purple-500 flex items-center gap-0.5 md:gap-1.5 animate-pulse">
      ...
      case 'pending':
        return (
          <span className="px-1.5 md:px-3 py-0.5 md:py-1.5 text-[8px] md:text-sm font-medium text-blue-500 bg-blue-900/30 backdrop-blur-md rounded-full border border-blue-500 flex items-center gap-0.5 md:gap-1.5">
            <svg className="w-2 h-2 md:w-3.5 md:h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <>
      <div className={`relative overflow-hidden border bg-gray-900/80 md:${cardColors.bg} border-gray-700 md:border-gray-600 border-l-4 rounded-lg shadow-none md:shadow-lg transition-all duration-200 ${cardColors.stripe} ${cardColors.hover}`}>
      <Link href={`/auctions/${auction.id}`}>
        ...
        <div className="border-b border-gray-700 pb-4 mb-4">
          ...
          <div className="relative flex items-start md:items-center gap-2 md:gap-3">
            ...
            <div className="flex md:hidden items-center gap-0 flex-shrink-0">
              {/* Model Image */}
              <div className="instagram-avatar-card">
              ...
              {linkedBusiness ? (
                <div className="relative z-10 -ml-[8px]">
                  <div
                    className="instagram-avatar-card cursor-pointer"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                ...
                <div className="relative z-10 -ml-[8px]">
                  <div
                    className="relative w-[50px] h-[50px] rounded-full overflow-hidden border border-dashed border-amber-500/30 cursor-pointer transition-all duration-200"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      setShowBusinessModal(true);
            ...
            <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center">
              ...
              {linkedBusiness ? (
                ...
                <div className="relative z-10 -ml-[10px] group">
                  <div
                    className="relative w-[54px] h-[54px] rounded-full overflow-hidden border border-dashed border-amber-500/30 cursor-pointer transition-all duration-200 hover:scale-110 hover:brightness-110"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      setShowBusinessModal(true);
          ...
          <div className="flex md:hidden items-center gap-1 -mt-5">
            {auction.status === 'active' && !isAuctionEnded(auction) && (
              <CompactAuctionTimer auction={auction} />
            )}
            {getStatusBadge()}
        ...
        <div className="mb-2 overflow-hidden">
          ...
          <div className="flex justify-between items-start gap-2 md:gap-3">
            ...
            <div className="flex gap-3 md:gap-6 items-start">
              ...
              {/* My Payout */}
              <div className="text-right relative group w-full">
                <p className="text-[10px] md:text-xs text-gray-400 uppercase tracking-wide text-right">My Payout</p>
                <p
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                  ...
                  className={`text-sm md:text-xl font-bold cursor-pointer hover:scale-110 transition-all duration-200 text-right ${
        ...
        {/* Action Buttons Row */}
        <div className="border-t border-gray-700 pt-2 pb-2 mx-2 overflow-hidden">
          ...
          <div className="flex gap-1 md:gap-2 items-center">
            ...
            <button
              ...
              className="text-xs md:text-sm px-3 py-1 md:py-1.5 transition-all border-0 rounded-lg hover:bg-white/10 flex items-center gap-1.5 md:gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
