                    ...
                    <div 
                      ...
                      className={`relative overflow-hidden border border-gray-600 border-l-4 rounded-lg shadow-lg p-5 transition-all duration-300 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/10 before:to-transparent before:translate-x-[-100%] hover:before:translate-x-[100%] before:transition-transform before:duration-700 before:ease-out ${
                        isNewPayLink
                          ...
                          : isPaid
                            ? 'bg-blue-900/50 border-l-green-500 hover:border-green-400 hover:bg-blue-800/50 hover:shadow-2xl hover:shadow-green-400/60 hover:scale-[1.01]'
                            : isInactive 
                              ? 'bg-blue-900/50 border-l-red-500 hover:border-red-400 hover:bg-blue-800/50 hover:shadow-2xl hover:shadow-red-400/60 hover:scale-[1.01]'
                              : 'bg-blue-900/50 border-l-purple-500 hover:border-purple-400 hover:bg-blue-800/50 hover:shadow-2xl hover:shadow-purple-400/60 hover:scale-[1.01]'
                      }`}>
