                  ...
                  <div className="flex flex-col items-end justify-between self-stretch flex-shrink-0">
                    ...
                    {offer.is_active && new Date(offer.expires_at) > new Date() && (
                      <button
                        ...
                        className="flex items-center justify-center p-1.5 border border-gray-500/50 text-gray-400 hover:bg-gray-500/10 hover:border-gray-500 hover:text-red-400 rounded-lg transition-colors disabled:opacity-50"
                        title="Deactivate"
                      >
                        {deactivating === offer.id ? (
