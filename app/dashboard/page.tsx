                  ...
                  >
                    {(profile?.profile_photo_url || profile?.companyProfileImage) ? (
                      ...
                      <div className="avatar-fallback">
                        ...
                        <span className="avatar-add-photo-text">Add Photo</span>
                      </div>
                    )}
                  </div>
                ) : (
                ...
                <div className="border-t border-gray-700 mt-3 pt-4">
                  <nav className="space-y-2">
                    ...
                    {(profile?.role === USER_ROLES.ADMIN || profile?.role === USER_ROLES.STAFF) && (
                      ...
                      >
                        <div className="flex items-center">
                          <svg className="w-4 h-4 mr-[5px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {(profile?.role === USER_ROLES.ADMIN || profile?.role === USER_ROLES.STAFF) && (
                      ...
                      >
                        <div className="flex items-center">
                          <span className="w-4 h-4 mr-[5px] flex-shrink-0 flex items-center justify-center text-base font-black">%</span>
                          Offers
                        </div>
                      </Link>
                    )}
