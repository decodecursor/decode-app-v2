    ...
    <div className="max-w-[400px] mx-auto px-4 py-6">
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex flex-col items-end justify-center gap-1 self-center">
          <span className="text-[13px] text-white/50">{remaining} offers left</span>
          <button
            onClick={() => {
              const text = window.location.href;
              window.location.href = `https://wa.me/?text=${encodeURIComponent(text)}`;
            }}
            className="flex items-center gap-1 text-[12px] font-medium text-[#25d366] hover:text-[#25d366]/80 transition-colors"
          >
