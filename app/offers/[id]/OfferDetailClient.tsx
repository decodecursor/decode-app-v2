  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <button
        ...
        className="flex items-center gap-1 px-2 py-1 rounded-full text-[9px] font-medium bg-[#25d366]/15 text-[#25d366] mb-4 ml-auto hover:bg-[#25d366]/25 transition-colors"
      >
