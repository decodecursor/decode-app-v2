    ...
    <div className="max-w-[400px] mx-auto px-4 py-6">
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex flex-col items-end gap-0">
          <span className="text-[13px] text-white/40 pr-2">{remaining} offers left</span>
          <button
            onClick={() => {
              const text = window.location.href;
              window.location.href = `https://wa.me/?text=${encodeURIComponent(text)}`;
            }}
            className="flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-medium bg-[#25d366]/15 text-[#25d366] hover:bg-[#25d366]/25 transition-colors"
          >
