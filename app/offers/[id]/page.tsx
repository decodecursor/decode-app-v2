    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="flex items-baseline justify-between mb-6">
        <div className="flex items-baseline gap-3">
          <span className="offers-price text-[50px]">
            <DirhamSymbol size={18} /> {offer.price}
          </span>
          {hasDiscount && (
            <span className="offers-price-original text-[42px]">
      ...
      <button
        onClick={() => {
          const text = `Check out this offer! 💅\n${window.location.href}`;
          window.open(`https://wa.me/?text=${encodeURIComponent(text)}`, '_blank');
        }}
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-[#25d366]/15 text-[#25d366] mb-4 mx-auto hover:bg-[#25d366]/25 transition-colors"
      >
