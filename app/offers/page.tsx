          ...
          <div className="flex-1 min-w-0">
            ...
            {offer.google_rating != null && (
              <p className="text-xs text-white/40 flex items-center">
                <svg className="w-3 h-3 shrink-0 fill-yellow-400 mr-0.5" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                {offer.google_rating.toFixed(1)}
                {offer.google_reviews_count != null && (
                  <span className="ml-0.5">({offer.google_reviews_count} reviews)</span>
                )}
              </p>
            )}
          </div>
          {/* Price */}
          <div className="flex items-start gap-1.5 flex-shrink-0 ml-auto self-start mt-0.5">
